...
data_ip="https://raw.githubusercontent.com/huutvpn/izin//main/admin"
reseller=$(curl -sS https://raw.githubusercontent.com/huutvpn/izin//main/admin | grep $MYIP | awk '{print $2}')
checking_sc() {
